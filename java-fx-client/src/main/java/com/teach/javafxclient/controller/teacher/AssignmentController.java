...
public class AssignmentController {
    ...
    public TableColumn<AssignmentEntity,String> submissionMethodColumn;
    ...
    public void initialize() throws InvocationTargetException, IllegalAccessException {
        ...
        req.put("userId","");
        res = httpRequestUtil.requestArrayList("/api/assignment/getAssignmentListByUserId",req); //从后台获取所有学生信息列表集合
        ...
        reso = optionItemHttpRequestUtil.requestArrayList("/api/course/getTeacherOptionItem",req);
    ...
    private void setupTable(){
        ...
        submissionMethodColumn.setCellValueFactory(new PropertyValueFactory<AssignmentEntity,String>("submissionMethod"));
    ...
    protected void changeAssignmentInfo() {
        ...
        submissionMethodField.setText(form.getSubmissionMethod());
